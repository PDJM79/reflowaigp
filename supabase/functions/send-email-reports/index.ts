// supabase/functions/send-email-reports/index.ts
// CRON-triggered email reports - requires X-Job-Token header
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.error('Error in send-email-reports function:', message);
